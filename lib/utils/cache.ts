...
const CACHE_NAME = "vibe-pages-vite-cache-v1";
...
/** 写入磁盘缓存 */
async function saveToDisk<T>(key: string, data: T, ttl: number): Promise<void> {
  try {
...
async function isUnderStoragePressure(): Promise<boolean> {
  try {
